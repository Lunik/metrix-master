;(function () {
  ...
  $.getJSON('/config.json', function (config) {
    ...
    function appendChartLatencyAv (avg) {
      ...
      drawBarChart(CHARTS['latency-avg'], Math.max.apply(CHARTS['latency-avg']), '.chart-info#latency-avg .canvas', 1)
    }
    ...
    function appendChartLoadAvg (avg) {
      ...
      drawBarChart(CHARTS['load-avg'], Math.max.apply(CHARTS['load-avg']), '.chart-info#load-avg .canvas', 1)
    }
